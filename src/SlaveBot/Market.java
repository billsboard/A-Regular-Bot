...
public class Market implements Serializable {
    ...
    public static void init(){
        ...
        Item[] weapons = {
                ...
                new Item("Spicy Stick", "Basically a horn drill", 17500, new int[]{0,0,0,0,0,0,0,0,1000,0,0,Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE,Integer.MAX_VALUE}, "weapon", 18),
