...
class LootBox {
    static Item[] LOOT = {
            ...
            new Weapon("Viola", "Deadly sound",
                    new int[]{100,145,150,200,Integer.MAX_VALUE}, new int[]{50,70,80}, null, 100, 1),
            new Weapon("Viola", "Deadly sound",
                    new int[]{100,145,150,200,Integer.MAX_VALUE}, new int[]{50,70,80}, null, 100, 1),            new Item("Viola", "Deadly sound", 1, new int[]{100,145,150,200,Integer.MAX_VALUE},"weapon"),
            new Weapon("Viola", "Deadly sound",
                    new int[]{100,145,150,200,Integer.MAX_VALUE}, new int[]{50,70,80}, null, 100, 1),            new Item("Viola", "Deadly sound", 1, new int[]{100,145,150,200,Integer.MAX_VALUE},"weapon"),
            new Weapon("Viola", "Deadly sound",
                    new int[]{100,145,150,200,Integer.MAX_VALUE}, new int[]{50,70,80}, null, 100, 1),            new Item("Viola", "Deadly sound", 1, new int[]{100,145,150,200,Integer.MAX_VALUE},"weapon"),
